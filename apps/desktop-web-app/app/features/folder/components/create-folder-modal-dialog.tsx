...
export const CreateFolderModalDialog: FC = () => {
  ...
  const dialogTriggerButtonRef = useRef<HTMLButtonElement>(null);
  ...
  const closeDialogByEsc = useCallback((event: KeyboardEvent) => {
  ...
  }, [addEventListeners, changeBackgroundScrollBehavior, isOpened]);
